...
class ChecksumsTest {
    ...
    public void parsePosixCksumOutput() throws Exception {
        ...
        assertThat(entries.get(0).getCksum()).isEqualTo(2172985434L);
        assertThat(entries.get(0).getFile()).isEqualTo("blaze.jar");
        assertThat(entries.get(2).getCksum()).isEqualTo(2392810308L);
        assertThat(entries.get(2).getFile()).isEqualTo("README.md");
    }
    ...
    public void parsePosixMd5Output() throws Exception {
        ...
        assertThat(entries).hasSize(3);
        assertThat(entries.get(0).getHash()).isEqualTo("84e7baeaf93b7ddd9b13ca1187a32c26");
        assertThat(entries.get(0).getFile()).isEqualTo("blaze.jar");
        assertThat(entries.get(2).getHash()).isEqualTo("e91b799c968c5f55bef214d296e35312");
        assertThat(entries.get(2).getFile()).isEqualTo("README.md");
    }
    ...
    public void parsePosixSha1Output() throws Exception {
        ...
        assertThat(entries).hasSize(3);
        assertThat(entries.get(0).getHash()).isEqualTo("f4aa081eb0e0a01ac232adce116c9c76d6bf00f8");
        assertThat(entries.get(0).getFile()).isEqualTo("blaze.jar");
        assertThat(entries.get(2).getHash()).isEqualTo("2f44473b039df1ab856a0051507c82efd09ee6c2");
        assertThat(entries.get(2).getFile()).isEqualTo("README.md");
    }
    ...
    public void parsePowershellHashFileOutput() throws Exception {
        ...
        assertThat(entries.get(0).getHash()).isEqualTo("7255E704ED4FB4DB41E11EE677715AD8".toLowerCase());
        assertThat(entries.get(0).getFile()).isEqualTo("C:\\Users\\builder\\test-sync\\.blaze\\blaze.java");
        assertThat(entries.get(1).getHash()).isEqualTo("901B64F7BAC049340CEB19F5602B975C".toLowerCase());
        assertThat(entries.get(1).getFile()).isEqualTo("C:\\Users\\builder\\test-sync\\.blaze\\pom.xml");
    }
    ...
    public void parsePowershellHashFileOutputWithWrappedLines() throws Exception {
        ...
        assertThat(entries.get(0).getHash()).isEqualTo("CE562E08D8098926A3862FC6E7905199".toLowerCase());
        assertThat(entries.get(0).getFile()).isEqualTo("C:\\Users\\builder\\test-sync\\.git\\modules\\MdeModulePkg\\Library\\BrotliCustomDecompressLib\\brotli\\hooks\\applypatch-msg.sample");
        assertThat(entries.get(6).getHash()).isEqualTo("39CB268E2A85D436B9EB6F47614C3CBC".toLowerCase());
        assertThat(entries.get(6).getFile()).isEqualTo("C:\\Users\\builder\\test-sync\\.git\\modules\\MdeModulePkg\\Library\\BrotliCustomDecompressLib\\brotli\\hooks\\pre-merge-commit.sample");
    }
